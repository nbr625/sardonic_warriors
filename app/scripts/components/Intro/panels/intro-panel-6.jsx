    ...
    render () {
        ...
        return (
            <div className="intro-panel-6">
                ...
                <div className="story-text" id="first-line">The erratic storm desperately needed to dump its negative charge; with</div>
                <div className="story-text" id="second-line">invisible, static arms it combed the landscape for a spike of positive energy</div>
